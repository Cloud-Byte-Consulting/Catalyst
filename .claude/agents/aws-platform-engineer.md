...
<!-- This file is a Claude Code subagent adapter for the canonical persona at agents/aws-platform-engineer.md. The persona body is included verbatim below so a Claude Code session sees the same content a Cursor session does at .cursor/agents/aws-platform-engineer.md. -->

<!-- BEGIN canonical agents/aws-platform-engineer.md -->
