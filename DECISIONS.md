...
- `ADR-021`: Hybrid forge — Gitea primary git, GitHub read mirror + issue host (Accepted; see `docs/ADR/ADR-021-migration-github-to-gitea.md` and `docs/gitea/`; renumbered from ADR-017 per #257)
